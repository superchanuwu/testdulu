...
// Variables
const rootDomain = "cmeta.my.id"; // Ganti dengan domain utama kalian
const serviceName = "jubi"; // Ganti dengan nama workers kalian
...
const PORTS = [443, 80];
const PROTOCOLS = ["trojan", "vless", "ss", "vmess"];
